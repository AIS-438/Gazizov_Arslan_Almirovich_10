...
* [Процесс настройки HTTPS и SSL-сертификата](#2-процесс-настройки-https-и-ssl-сертификата)
  ...
  * [Установка сертификата на веб-сервер](#22-установка-сертификата-на-веб-сервер)
    ...
    * [Установка на Linux-сервере (Nginx + Let's Encrypt)](#221-установка-на-linux-сервере-nginx--lets-encrypt)
    * [Установка на Windows-сервере (IIS)](#222-установка-на-windows-сервере-iis)
  * [Принудительное перенаправление с HTTP на HTTPS](#23-принудительное-перенаправление-с-http-на-https)

    * [Настройка на Linux (Nginx)](#231-настройка-на-linux-nginx)
    * [Настройка на Windows (IIS)](#232-настройка-на-windows-iis)
* [Дополнительные меры безопасности и оптимизации](#3-дополнительные-меры-безопасности-и-оптимизации)
