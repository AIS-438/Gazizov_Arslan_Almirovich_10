...
* [1. Теоретические основы](#1-теоретические-основы)
  ...
  * [1.1 Ключевые понятия](#11-ключевые-понятия)
  * [1.2 Принцип работы HTTPS](#12-принцип-работы-https)
  * [1.3 Типы SSL-сертификатов](#13-типы-ssl-сертификатов)
* [2. Процесс настройки HTTPS и SSL-сертификата](#2-процесс-настройки-https-и-ssl-сертификата)

  * [2.1 Выбор и получение сертификата](#21-выбор-и-получение-сертификата)
  * [2.2 Установка сертификата на веб-сервер](#22-установка-сертификата-на-веб-сервер)

    * [2.2.1 Установка на Linux-сервере (Nginx + Let's Encrypt)](#221-установка-на-linux-сервере-nginx--lets-encrypt)
    * [2.2.2 Установка на Windows-сервере (IIS)](#222-установка-на-windows-сервере-iis)
  * [2.3 Принудительное перенаправление с HTTP на HTTPS](#23-принудительное-перенаправление-с-http-на-https)

    * [2.3.1 Настройка на Linux (Nginx)](#231-настройка-на-linux-nginx)
    * [2.3.2 Настройка на Windows (IIS)](#232-настройка-на-windows-iis)
* [3. Дополнительные меры безопасности и оптимизации](#3-дополнительные-меры-безопасности-и-оптимизации)
* [4. Особенности настройки](#4-особенности-настройки)
